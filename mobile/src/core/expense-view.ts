 ...
 *
 * ⚠️ ORTAK ÇEKİRDEK: telefonun Giderler ekranı da AYNI dönem hesabını kullanır. Bir tur yalnız
 * masaüstündeydi; telefon tüm zamanların toplamını gösteriyordu ("PC'deki gibi aylık değil").
 */
...
export const PERIYOTLAR: { id: PeriyotTipi; label: string; kisa: string }[] = [
...
export function aylaraGore<T extends GiderSatiri>(giderler: T[]): AyGrubu<T>[] {
