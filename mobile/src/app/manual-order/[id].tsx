...
const styles = StyleSheet.create({
  ...
  help: { color: ML.textFaint, fontFamily: font.medium, fontSize: 12, lineHeight: 17 },
  ...
  statusChipText: { color: ML.textDim, fontSize: 12, fontFamily: font.semibold },
  statusChipTextOn: { color: ML.accent, fontFamily: font.extrabold },
  outlineButton: {
  ...
  outlineButtonText: { color: ML.accent, fontSize: 14, fontFamily: font.extrabold },
  itemCard: {
  ...
  itemName: { color: ML.text, fontSize: 14, fontFamily: font.bold },
  itemHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  itemIndex: { color: ML.textFaint, fontSize: 10, fontFamily: font.extrabold, letterSpacing: 1 },
  removeText: { color: ML.red, fontSize: 12, fontFamily: font.bold },
  ...
  quantityButtonText: { color: ML.accent, fontSize: 20, fontFamily: font.bold },
  quantityValue: {
    color: ML.text,
    minWidth: 34,
    textAlign: "center",
  ...
  filamentChipText: { color: ML.textDim, fontSize: 12, fontFamily: font.semibold },
  filamentChipTextOn: { color: ML.accent, fontFamily: font.extrabold },
  unitCostRow: { flexDirection: "row", alignItems: "center", gap: 12 },
  unitCostLabel: { color: ML.textFaint, fontSize: 11, fontFamily: font.extrabold, letterSpacing: 1 },
  unitCostValue: {
    color: ML.text,
    fontSize: 17,
    fontFamily: font.extrabold,
  ...
  toggleTitle: { color: ML.text, fontSize: 14, fontFamily: font.bold },
  invoiceRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: 10,
  ...
  invoiceTitle: { color: ML.textDim, fontSize: 13, fontFamily: font.semibold },
  moneyCost: { gap: 9 },
  expenseCard: {
    backgroundColor: ML.cardElevated,
    borderRadius: radius.md,
  ...
  checkText: { color: "#fff", fontSize: 13, fontFamily: font.extrabold },
  expenseName: { color: ML.text, fontSize: 14, fontFamily: font.bold },
  customExpense: {
    backgroundColor: ML.cardElevated,
    borderRadius: radius.md,
    borderWidth: 1,
  ...
  breakdownLabel: { color: ML.textDim, fontFamily: font.medium, fontSize: 13 },
  breakdownValue: {
    color: ML.text,
    fontSize: 13,
  ...
  profitLabel: { color: ML.textFaint, fontSize: 11, fontFamily: font.extrabold, letterSpacing: 1 },
  profitValue: { fontSize: 20, fontFamily: font.extrabold, textAlign: "right" },
  warning: {
    color: ML.orange,
  ...
  pickerTitle: { color: ML.text, fontSize: 24, fontFamily: font.extrabold },
  pickerClose: { color: ML.accent, fontSize: 15, fontFamily: font.extrabold },
